...
import { User as UserModel, Post as PostModel, Profile } from '@prisma/client';
...
export class AppController {
  ...
  async createUserProfile(@Param('id') id: string, @Body() userBio: { bio: string }): Promise<Profile> {
